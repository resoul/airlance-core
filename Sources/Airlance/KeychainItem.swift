...
public struct KeychainItem {
    ...
    public static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "org.airlance", account: "userIdentifier").readItem()
    ...
    public static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "org.airlance", account: "userIdentifier").deleteItem()
        } catch {
